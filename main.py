...
class MainWidget(Widget):
    ...
    # __init__ act as class ( declaration not definition )
    ...
    # Analyze platform you used
    def is_desktop(self):
        if platform in ('linux', 'win', 'macosx'):
            return True
        return False

    # Specialize for ship generation in application
    def init_ship(self):
        with self.canvas:
            Color(0, 0, 0)
            self.ship = Triangle()
    ...
    def check_ship_collision_with_tile(self, ti_x, ti_y):
        ...
        for i in range(0, 3):
            ...
            if xmin <= px <= xmax and ymin <= py <= ymax:
                return True
        return False
    # Specialize for ship generation in application END HERE

    # Specialize for tile generation in application
    def init_tiles(self):
        with self.canvas:
            Color(1, 1, 1)
    ...
    # Specialize for tile generation in application END HERE
    ...
    def on_keyboard_down(self, keyboard, keycode, on_touch, off_touch):
        if keycode[1] == 'left':
    ...
    # print("update")
    # Generate new tile and related to ship movement
    def update(self, dt):
        time_factor = dt * 60
